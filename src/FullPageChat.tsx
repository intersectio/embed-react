...
import type { BotProps } from 'cubieai-embed'
...
declare global {
  namespace JSX {
    interface IntrinsicElements {
      'cubieai-fullchatbot': React.DetailedHTMLProps<
...
export const FullPageChat = ({ style, className, ...assignableProps }: Props) => {
  ...
  useEffect(() => {
    ;(async () => {
      await import('cubieai-embed/dist/web')
    })()
  }, [])
  ...
  return <cubieai-fullchatbot ref={ref} style={style} class={className} />
}
